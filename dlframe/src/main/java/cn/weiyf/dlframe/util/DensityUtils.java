...
public class DensityUtils {
    ...
    public static DisplayMetrics getDisplayMetrics() {
        return DLFrame.getInstance().getResources().getDisplayMetrics();
    }
    ...
    public static int getScreenRealHeight() {
        int h;
        WindowManager winMgr = (WindowManager) DLFrame.getInstance().getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = DLFrame.getInstance().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources resources = DLFrame.getInstance().getResources();
