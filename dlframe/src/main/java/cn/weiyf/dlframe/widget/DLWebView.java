package cn.weiyf.dlframe.widget;
 ...
 */
public class DLWebView extends WebView {
    ...
    public DLWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DLWebView(Context context, AttributeSet attrs, int defStyleAttr) {
